...
export default function Sidebar() {
  ...
  const MenuOption = [
    ...
    { id: 2, name: 'Payments', path: '/admin/payments', icon: IndianRupee }, // Updated path
    { id: 3, name: 'Analytics', path: '/admin/analytics', icon: BarChart3 },
    { id: 4, name: 'Manage Courses', path: '/admin/manage-courses', icon: BookOpen },
    { id: 5, name: 'Manage Users', path: '/admin/manage-users', icon: Users },
    { id: 6, name: 'Notebook', path: '/admin/notebook', icon: Notebook },
  ]
