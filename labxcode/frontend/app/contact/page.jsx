            ...
            <div className="space-y-8">
              ...
              <div className="rounded-2xl p-8 shadow-2xl font-medium text-xl text-gray-800">
                ...
                <div className="relative bg-white/20 backdrop-blur-lg rounded-3xl p-8 border shadow-2xl  hover:shadow-blue-800 border-white/20">
                  ...
                  <h3 className="text-2xl font-bold mb-4 text-blue-800 font-bold">Why Choose LabXCode?</h3>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              ...
              <div className="space-y-6">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-md  font-bold font-medium text-gray-900 mb-2">
                      Email Address *
                    </label>
                    <input
                      type="email"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full font-bold  font-medium font-sans px-4 py-3 border border-gray-300 rounded-lg  placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all resize-none"
                ...
                <button
                  ...
                  className="w-full  bg-blue-900 hover:bg-violet-800    disabled:from-gray-500 disabled:to-gray-600 text-white text-xl font-bold  font-semibold py-4 px-6 rounded-lg transition-all duration-300 flex items-center justify-center space-x-2 group"
                >
                  {isSubmitting ? (
                    <>
